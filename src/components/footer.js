        ...
        <div className="mx-auto  max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8">
              ...
              We are a family centered practice that incorporates
compassion and dedication to promote your well being.
              </p>
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              ...
              <div className="md:grid md:grid-cols-1 md:gap-8">
                <div>
                  ...
                  <h2 class="text-[20px] text-[#2a3d53] leading-7 font-bold">ติดต่อเรา</h2>
            ...
            <div key={perk.name} className="sm:flex">
              <div className="sm:flex-shrink-0">
                <div className="flow-root">
                  <img className=" w-5" src={perk.imageSrc} alt="" />
                </div>
              </div>
              <div className="mt-3 sm:mt-0 sm:ml-3">
                <h3 className="text-sm font-bold text-[#2a3d53]">{perk.name}</h3>
                <p className="mt-2 text-sm text-[#2a3d53]">{perk.description}</p>
              </div>
            </div>
          ))}
        </div>
